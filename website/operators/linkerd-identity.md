...
Source: [`apps/fleet-operator/src/tenants/deploy/silo-linkerd-identity.ts`](https://github.com/italanta/opencrane/blob/main/apps/fleet-operator/src/tenants/deploy/silo-linkerd-identity.ts)
...
The operator picks this up at startup via `_readEnvValue<boolean>("LINKERD_MESH_ENABLED", "boolean", false, false)` in [`apps/fleet-operator/src/config.ts`](https://github.com/italanta/opencrane/blob/main/apps/fleet-operator/src/config.ts). The default is `false`.
