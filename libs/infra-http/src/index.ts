 ...
 * and the public OpenAPI route. Each helper is app-agnostic (the OpenAPI spec + the Prisma
 * client are injected) so the two managers' divergent generated Prisma clients both work
 * without this lib importing either Prisma package.
 */
