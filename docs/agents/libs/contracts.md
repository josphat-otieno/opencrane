...
The control-plane emits `apps/clustertenant-manager/openapi.json`; the contracts `generate` script runs
`openapi-typescript apps/clustertenant-manager/openapi.json -o src/generated/api.ts`, and `build` is
