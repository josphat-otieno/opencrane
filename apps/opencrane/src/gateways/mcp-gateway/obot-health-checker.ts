 ...
 *
 * Obot self-syncs its MCP server catalog from the opencrane-ui registry
 ...
 *
 * @see apps/opencrane-infra/templates/obot-mcp-gateway-deployment.yaml — deployment
...
export class ObotHealthChecker
{
   ...
   * (`apps/opencrane-infra/templates/obot-mcp-gateway-deployment.yaml`), which Obot
