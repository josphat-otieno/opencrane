...
docker build -f "$ROOT_DIR/apps/fleet-manager/deploy/Dockerfile" -t opencrane/operator:e2e "$ROOT_DIR"
...
#    operator retired per-user Ingresses (apps/fleet-manager/src/tenants/operator.ts) — every
