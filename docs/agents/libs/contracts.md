...
The control-plane emits `apps/clustertenant-platform/openapi.json`; the contracts `generate` script runs
`openapi-typescript apps/clustertenant-platform/openapi.json -o src/generated/api.ts`, and `build` is
