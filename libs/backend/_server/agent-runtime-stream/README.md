# @opencrane/backend/_server/agent-runtime-stream — runtime-initiated transport

> [backend](../../README.md) › [_server](../README.md) › agent-runtime-stream
...
- Parent index: [_server](../README.md)
