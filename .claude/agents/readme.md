...
first. A mechanism (a flag, endpoint, generated-client call, file path) earns a mention only when it
...
- **Quick Start** — install, deploy, create a tenant, and use the UI or REST API.
- **License.**
