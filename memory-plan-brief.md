...
-> ANSWER: Datasets are personal, project-wide, team-wide, . All tenants have access to org-wide info.  Each tenant further has a personal cognee. Finally, Tenants are bound to projects, team and department datasets from the control-plane.
