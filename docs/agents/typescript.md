...
- **pnpm monorepo, pure ESM.** Every package is `"type": "module"`; `tsconfig.base.json` is `module: NodeNext`, `target: es2023`, `strict`. There are 5 apps (`apps/*`) + domain packages (`libs/domain/*/main`), shared infra/util libs (`libs/awareness`, `libs/contracts`, `libs/infra-*`, `libs/k8s-platform`, `libs/observability`, `libs/util`); see [`app-specific.md`](./app-specific.md) for the map.
