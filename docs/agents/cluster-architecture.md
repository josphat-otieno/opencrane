...
│  control-plane host → control-plane:8080 · *.<base> → operator proxy → UserTenant pods │
└────────────────────────────────────────────────────────────────────────┘
```
...
There are exactly **two platform-owned DNS entries** — a fixed super-operator/control-plane host, and one
