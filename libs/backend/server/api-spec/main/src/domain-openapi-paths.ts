import { _PersonalRunAdmissionOpenapiPaths } from "@opencrane/backend/agents/execution/admission";
...
export const _DomainOpenapiPaths = {
	...
	"/me/runs": { ..._SelfRunStatusOpenapiPaths["/me/runs"], ..._PersonalRunAdmissionOpenapiPaths["/me/runs"] },
